...
/**
 * The type Order with route dto.
 */
public class OrderWithRouteDTO {
    private String id;
    ...
    /**
     * Instantiates a new Order with route dto.
     */
    public OrderWithRouteDTO() {
    }
     ...
     */
    public OrderWithRouteDTO(String id, String personalNumber, String description, String date, String status, String assignedTruckId, String assignedTruckRegistrationNumber, String[] cargosInOrder, String[] assignedDrivers, String[] route) {
        this.id = id;
